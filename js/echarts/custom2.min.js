...
if($("#rstat_package_chart").length){var f=echarts.init(document.getElementById("rstat_package_chart"),a);f.setOption({title:{text:"R-Package Downloads",subtext:"Yearly Downloads"},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Number of Downloads"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar",stack:"Stack"},type:["line","bar","stack"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data:["2012", "2013","2014","2015","2016","2017"]}],yAxis:[{type:"value"}],series:[{name:"Number of Downloads",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:[1344952,23582807,59499767,138330084,218480053, 382255322]}]})}

if($("#rstat_quarterly_package_chart").length){var f=echarts.init(document.getElementById("rstat_quarterly_package_chart"),a);f.setOption({title:{text:"R-Package Downloads",subtext:"Half-Yearly Downloads"},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Quarter 1","Quarter 2"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar",stack:"Stack"},type:["line","bar","stack"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data:["2012","2013", "2014", "2015", "2016", "2017"]}],yAxis:[{type:"value"}],series:[{name:"Quarter 1",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:[0,9232771,24488696,58204804,95865760, 182166297]},{name:"Quarter 2",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:[1344952,14350036,35011071,80125280,122614293, 200089025]}]})}

if($("#rstat_so_tag_chart").length){var f=echarts.init(document.getElementById("rstat_so_tag_chart"),a);f.setOption({title:{text:"StackOverflow Questions Tagged R",subtext:"Yearly Question Count"},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Number of Questions"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar",stack:"Stack"},type:["line","bar","stack"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data:["2008","2009","2010","2011","2012","2013","2014","2015","2016","2017"]}],yAxis:[{type:"value"}],series:[{name:"Number of Questions",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:[8,524,2267,5838,12196, 22287, 30948, 40760, 44541, 54363]}]})}

if($("#rstat_so_count_chart").length){var f=echarts.init(document.getElementById("rstat_so_count_chart"),a);f.setOption({title:{text:"StackOverflow Questions Tagged R",subtext:"Summary of Question, Answer and Comment Counts"},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Total Questions","Total Answers","Total Comments"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar",stack:"Stack"},type:["line","bar","stack"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data:["2008","2009","2010","2011","2012","2013","2014","2015","2016","2017"]}],yAxis:[{type:"value"}],series:[{name:"Total Questions",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:[8,524,2267,5838,12196, 22287, 30948, 40760, 44541, 54363]},{name:"Total Answers",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:[65,1931,6229,13062,21519,34962,43535,51224,53271,58695]},{name:"Total Comments",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:[12,544,2823,10271,23065, 46101, 63904, 91439, 98710, 106650]}]})}

if($("#rstat_so_views_chart").length){var f=echarts.init(document.getElementById("rstat_so_views_chart"),a);f.setOption({title:{text:"StackOverflow Questions Tagged R",subtext:"Yearly Page Views"},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Number of PageViews"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar",stack:"Stack"},type:["line","bar","stack"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data:["2008","2009","2010","2011","2012","2013","2014","2015","2016","2017"]}],yAxis:[{type:"value"}],series:[{name:"Number of PageViews",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:[292806,13717083,30437833,53492435,64000701, 69273444, 51386502, 33965427, 20298876, 10307469]}]})}

if($("#rstat_rbloggers_chart").length){var f=echarts.init(document.getElementById("rstat_rbloggers_chart"),a);f.setOption({title:{text:"RBloggers.com",subtext:"Yearly Blog Posts"},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Number of Blog Posts"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar",stack:"Stack"},type:["line","bar","stack"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data:["2007","2008","2009","2010","2011","2012","2013","2014","2015","2016","2017"]}],yAxis:[{type:"value"}],series:[{name:"Number of Blog Posts",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:[70,103,715,2048,2853, 3407, 3160, 2952, 2704, 3278, 3359]}]})}


if($("#echart_scatter").length){var g=echarts.init(document.getElementById("echart_scatter"),a);g.setOption({title:{text:"Scatter Graph",subtext:"Heinz  2003"},tooltip:{trigger:"axis",showDelay:0,axisPointer:{type:"cross",lineStyle:{type:"dashed",width:1}}},legend:{data:["Data2","Data1"]},toolbox:{show:!0,feature:{saveAsImage:{show:!0,title:"Save Image"}}},xAxis:[{type:"category",boundaryGap:!0}],yAxis:[{type:"value",scale:!0,axisLabel:{formatter:"{value} "}}],series:[{name:"Data1",type:"scatter",data:[["2.0.0", 55],["2.0.1", 24],["2.1.0", 37],["2.1.1", 42],["2.10.0", 226],["2.10.1", 212],
["2.11.0", 378],
["2.11.1", 332],
["2.12.0", 226],
["2.12.1", 217],
...
["devel", 504],
["latest", 5744],
["release.exe", 119]],markPoint:{data:[{type:"max",name:"Max"},{type:"min",name:"Min"}]},markLine:{data:[{type:"average",name:"Mean"}]}},{name:"Data2",type:"scatter",data:[["2.0.0", 30],
["2.0.1", 18],
["2.1.0", 26],
["2.1.1", 35],
["2.10.0", 124],
